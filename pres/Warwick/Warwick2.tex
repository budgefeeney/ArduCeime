...
\begin{description}
\item[Mean Reciprocal Rank]: $\frac{1}{D} \sum_d \frac{1}{Q} \sum_q r_q$. 
\item[Recall at M]: The number of correct links found in the top $m$ links returned for a document as a proportion of the total number of correct links. 
\item[Precision at M]: The proportion of correct links found in the top $m$ links returned for a document.
...
\end{description}
These all then averaged across all documents in the corpus.

Mean reciprocal-rank, is the average of the reciprocal of the ranks of all held-out links across all documents: $mrr =  
