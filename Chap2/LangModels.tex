...
One can augment back-off models with interpolation. \fixme{Taking Knesser Ney again}. An interpolated variant of Knesser-Ney was derived in\cite{Goodman2001}\fixme{Nope, I have the 1996 and 2001 papers, but not the 1999 paper). called ``modified Knesser-Ney" which is one of the best performing language models currently in use. This is defined as
