...
{\color{red}
{\bf Impact of Time of Week Features:}
This showed no real significant impact over just author+month+week. Perhaps had I used hour of week, with overlapping hour trigrams, I may have captured something, but wouldn't that sort of manual feature-construction suggest the model's not working?}.
