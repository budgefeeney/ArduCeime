...
\begin{table}
    \begin{tabular}{| l || l | p{7cm} | } \hline 
        Hashtag & User (Internal) & Tweet Words \\ \hline
        \tt{usopen} & BreakPointBR & slam um gs 2007 oitava desd essa qf sua em gasquet foi na wimbledon de grand primeira 2ª apena | \\ \hline
        \tt{f1} & AustinGrandPrix & mt shout volunt big singapor heartfelt out austin thank you marshal here all \\ \hline
        \tt{obama} & CraryAP & danger awai unstabl dem bill senat other delaware from peopl keep reject guncontrol nra gun \\ \hline
        \tt{beer} & Beer\_Disciples & barrel annual brewhous expand growth track capac 150 10,000 \\ \hline
        \tt{stones50} & RollingStones & summer park stone live hyde sweet youtub sun roll trailer \\ \hline
    \end{tabular}
    \caption{This table shows, for each hashtag, the tweet where that hashtag has the highest probability according to our model, yet is not present. Due to stemming, the words shown are not exactly as in the original tweet.}
